...
- This is the same numeric spec the installed `claude-seo-ai:seo-geo-answerblocks` skill (module M11) checks for when *auditing* an existing page — writing to it here means a later audit pass should find nothing to fix.
